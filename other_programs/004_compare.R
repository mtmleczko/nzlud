...
save(nzlu.data,
     file = "Y:/Zoning/ZoningI/Data/Processed/Out/nzlu_muni_data.Rda")

## csv ##
write.csv(nzlu.data,
     file = "Y:/Zoning/ZoningI/Data/Processed/Out/nzlu_muni_data.csv")
...
write.csv(nzlu.msa.2019.final,
          file = "Y:/Zoning/ZoningI/Data/Processed/Out/nzlu_msa_data.csv")
